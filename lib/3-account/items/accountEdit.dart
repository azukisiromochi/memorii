...
class _AccountEditState extends State<AccountEdit> {
  ...
  final userInstagramInputController = TextEditingController();
  final userTiktokInputController = TextEditingController();
  final userShortTextInputController = TextEditingController();
  final userTextInputController = TextEditingController();
  String likeStyleOne = '';
  String likeStyleTwo = '';
  String nowJob = '';
  String prefecture = '';
  ...
  bool warningInstagram = false;
  bool warningInstagramAtt = false;
  bool warningSchool = false;
  ...
  void initState() {
    super.initState();
    userNameInputController.text = UserData.instance.account[0]['user_name'];
    userInstagramInputController.text = UserData.instance.account[0]['user_instagram'];
    userTiktokInputController.text = UserData.instance.account[0]['user_tiktok'];
    userShortTextInputController.text = UserData.instance.account[0]['user_short'];
    userTextInputController.text = UserData.instance.account[0]['user_text'];
    
    likeStyleOne = UserData.instance.account[0]['user_info'][0];
    likeStyleTwo = UserData.instance.account[0]['user_info'][1];
    nowBest = UserData.instance.account[0]['user_info'][2];
    nowFight = UserData.instance.account[0]['user_info'][3];
    prefecture = UserData.instance.account[0]['user_info'][4];
    nowSchool = UserData.instance.account[0]['user_info'][5];
  ...
  Future <void> textUpdate() async {
    ...
    .update({
      'user_name': userNameInputController.text,
      'user_instagram': userInstagramInputController.text,
      'user_tiktok': userTiktokInputController.text,
      'user_short': userShortTextInputController.text,
      'user_text': userTextInputController.text,
      'user_info': [likeStyleOne,likeStyleTwo,nowBest,nowFight,prefecture,nowSchool,userInstagramInputController.text,userTiktokInputController.text,],
    });

    if (UserData.instance.account[0]['user_name'] == userInstagramInputController.text) {
      ...
      for (var sfRef in referenceId) {
        batch.update(sfRef, {"post_instagram": userInstagramInputController.text});
      }
      batch.commit();
    }
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  onTap: () {
                    warningName = false;
                    warningInstagram = false;
                    warningInstagramAtt = false;
                    warningSchool = false;
                    if (userNameInputController.text == "") {
                      warningName = true;
                    } else if  (userInstagramInputController.text == "") {
                      warningInstagram = true;
                    } else if  (userInstagramInputController.text.contains("@")) {
                      warningInstagramAtt = true;
                    } else if  (userTextInputController.text == "") {
                      warningSchool = true;
                    } else {
                      textUpdate();
                    }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          minLines: 1,
                          autovalidateMode: AutovalidateMode.always,
                          controller: userInstagramInputController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                          ),
                        ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          minLines: 1,
                          autovalidateMode: AutovalidateMode.always,
                          controller: userTiktokInputController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                          ),
                        ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          minLines: 1,
                          autovalidateMode: AutovalidateMode.always,
                          controller: userShortTextInputController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                          ),
                        ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          minLines: 1,
                          autovalidateMode: AutovalidateMode.always,
                          controller: userTextInputController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                          ),
                        ),
